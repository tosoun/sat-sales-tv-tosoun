...
GROUPS_MAPPING = {
    ...
    "πατ": ["τρικαλα", "καρδιτσα", "ελασσονα", "φαρσαλα"],
    "πατσης": [
...
with col_head1:
  search_query = st.text_input(
      "🔍 Αναζήτηση / Γκρουπ (π.χ. ΧΑΡΑΛΑΜΠΙΔΗΣ, ΜΗΤΡΟΥΛΗΣ, ΠΑΠ, ΠΑΤ, ΠΑΤΣΗΣ, ΠΟΝ, ΣΚΙ):",
...
try:
  ...
  st.error(f"Σφάλμα: {e}")Audio play blocked:", error.message);
                    });
                }
            }
