...
MITROULIS_KEYWORDS = [
    ...
    "25ης μαρτιου", "ελ.βενιζελου", "ιωαννη αρχη", "κοζανης και γρεβενων",
    "χλόη", "δισπυλο", "αθ. διακου", "γραμμου", "μανιακοι"
]

PONOPOULOS_KEYWORDS = [
    "231", "232", "233", "373", "237", "235", "372", "236", "483", "161",
    "166", "384", "234", "σβορωνού", "σβορωνου", "υψηλαντου", "περδικα",
    "εγνατιας", "πλαταμωνας", "λεπτοκαρυα", "κορινος", "αγ.νικολαιου",
    "αγ.νικολάου", "λιτοχωρο", "αντιγονου", "κατερινη", "αριστοτελους",
    "π.τσαλδαρη", "19ης μαΐου", "χατζογλου"
]

CHARALAMPIDIS_KEYWORDS = [
    "211", "201", "347", "212", "239", "219", "220", "222", "223", "240",
    "241", "493", "δ.γεωργιαδου", "λαρισα", "νικηταρα", "ιωαννινων",
    "23ης οκτωβριου", "χατζημιχαλη", "φιλιππούπολη", "φυλιππουπολη",
    "θυατειρων", "βενιζελου", "ν.ιωνια", "βολος", "αχιλλοπουλου",
    "κασσαβετη", "28ης οκτωβριου", "κουμουνδουρου", "μεταμορφωσεως",
    "αλεξανδρας", "σκιαθος"
]
...
PATSIS_KEYWORDS = [
    "198", "225", "226", "316", "317", "381", "227", "228", "229", "224",
    "315", "359", "378", "γκουρας", "νικοπολεως", "ιωαννινα", "γ.παπανδρεου",
    "κατω νεοχωροπουλο", "μαρικας κοτοπουλη", "ριζαριο", "λεωφ. δημοκρατιας",
    "καρδαμιτσια", "κοραη", "κ.παλαιολογου", "ανατολη", "καρυωτακη",
    "λεωφ. ειρηνης", "πρεβεζα", "πλ. κιλκις", "ανεξαρτησιας", "αρτα",
    "26ο χλμ", "λουρος", "ηγουμενιτσα", "θεσπρωτιας", "παραμυθια"
]
