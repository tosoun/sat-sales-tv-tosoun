...
st.markdown(
    """
    <style>
    .row-widget.stSelectbox { margin-bottom: 0px !important; }
        ...
        if password == "2845":
            ...
            if uploaded_file_1 is not None and uploaded_file_2 is not None:
                ...
                try:
                    ...
                    if hasattr(st, "secrets") and "REPO_NAME" in st.secrets:
                ...
                st.success(
                    "Και τα δύο αρχεία ανέβηκαν αυτόματα και συγχρονίστηκαν επιτυχώς!"
                )
...
def process_sales_df(df, file_name=""):
    ...
    target_col_idx = 1 if is_prosfores else 1
...
MITROULIS_KEYWORDS = [
    "301", "302", "309", "486", "304", "352", "308", "353", "354", "355",
    "356", "366", "374", "αιανη", "πλ.ελευθεριας", "πλ.λασσανη", "σιατιστα",
    "25ης μαρτιου", "ελ.βενιζελου", "ιωαννη αρθη", "κοζανης και γρεβενων",
    "χλοη", "δισπυλο", "αθ. διακου", "γραμμου", "μανιακοι"
]

PONOPOULOS_KEYWORDS = [
    "231", "232", "233", "373", "237", "235", "372", "236", "483", "161",
    "166", "384", "234", "σβορωνου", "υψηλαντου", "περδικα", "εγνατιας",
    "πλαταμωνας", "λεπτοκαρυα", "κορινος", "αγ.νικολαιου", "λιτοχωρο",
    "αντιγονου", "κατερινη", "αριστοτελους", "π.τσαλδαρη", "19ης μαΐου",
    "χατζογλου"
]

CHARALAMPIDIS_KEYWORDS = [
    "211", "201", "347", "212", "239", "219", "220", "222", "223", "240",
    "241", "493", "δ.γεωργιαδου", "λαρισα", "νικηταρα", "ιωαννινων",
    "23ης οκτωβριου", "χατζημιχαλη", "φιλιππουπολη", "θυατειρων",
    "βενιζελου", "ν.ιωνια", "βολος", "αχιλλοπουλου", "κασσαβετη",
    "28ης οκτωβριου", "κουμουνδουρου", "μεταμορφωσεως", "αλεξανδρας", "σκιαθος"
]

PAPPAS_KEYWORDS = [
    "210", "346", "202", "204", "206", "209", "205", "207", "208", "215",
    "ελασσονα", "βυζαντιου", "λαρισης", "φαρσαλα", "αβερωφ", "καρδιτσα",
    "καραϊσκακη", "σοφαδες", "κονδυλη", "τρικαλα", "δεληγιωργη", "ελευθεριος"
]

PATSIS_KEYWORDS = [
    "198", "225", "226", "316", "317", "381", "228", "229", "224",
    "315", "359", "378", "399", "444", "γκουρας", "νικοπολεως", "ιωαννινα",
    "γ.παπανδρεου", "κατω νεοχωροπουλο", "μαρικας κοτοπουλη", "ριζαριο",
    "λεωφ. δημοκρατιας", "καρδαμιτσια", "κοραη", "κ.παλαιολογου", "ανατολη",
    "καρυωτακη", "λεωφ. ειρηνης", "πρεβεζα", "πλ. κιλκις", "ανεξαρτησιας",
    "αρτα", "26ο χλμ", "λουρος", "ηγουμενιτσα", "θεσπρωτιας", "παραμυθια",
    "αγ.μαρινας"
]

SKIADOPOULOS_KEYWORDS = [
    "531", "539", "567", "537", "533", "525", "535", "534", "566", "540",
    "565", "530", "528", "529", "532", "536", "538", "549", "κερκυρα",
    "αχαραβη", "κασσιωπη", "σιδαρι", "καρουσαδες", "μαρκατο", "μαντουκι",
    "αλυκες", "υπερ εθνικη οδος λευκιμμης", "λευκιμμη", "μωραιτικα",
    "κομβος βρυωνη", "καστελλοι", "αλεπου", "σαροκο", "ιωαννου θεοτοκη",
    "παλλαδα", "λαικη αγορα", "γερασιμου", "πινια", "νοσοκομειο", "σπηλια",
    "μητροπολιτου μεθοδιου"
]

SAMOGLOU_KEYWORDS = [
    "8907", "8912", "8913", "8918", "8920", "8926", "8932", "8933", "8938",
    "8939", "8941", "8943", "καστορια χιλιοδενδρο", "καστορια αγ μηνα",
    "καστορια μ αλεξανδρου", "κοζανη παυλου χαριση", "γρεβενα μακεδονομαχων",
    "σερβια κοζανης κων καρπου", "βελβεντος κοζανης", "κοζανη οσε",
    "γρεβενα θεωδ ζιακα", "γρεβενα καβαφη", "κοζανη φιλιππου"
]

BOUTSKOS_KEYWORDS = [
    "8267", "8273", "8317", "8318", "8334", "8402", "8408", "8448", "8568",
    "8569", "8591", "δομοκος παπαφλεσσα", "πλαταμωνας κων καραμανλη",
    "αλμυρος βολου ν μιχοπουλου", "θεσ σινδος παλαιολογου", "θεσ ολυμπου",
    "λαρισα στρατηγου φραγκου", "σκοπελος 2 χλμ επο σκοπελου",
    "λαρισα ιωαννινων", "βολος γιαννη δημου συ", "στεφανοβικειο βελεστινο συ",
    "αγια λαρισης"
]

POUTOGLIDIS_KEYWORDS = [
    "8333", "8916", "8917", "8923", "8925", "8928", "8931", "8936", "8937",
    "8940", "8945", "πτολεμαιδα 25 μαρτιου", "φλωρινα κρεσνας",
    "φλωρινα καστρισιανακη", "φλωρινα δημ παπαθανασιου",
    "κροκος κοζανης ιοακ λιουλια", "φιλιωτας μ αλεξανδρου",
    "αμυνταιο 28 συνταγμπ πεζικου", "πτολεμαιδα χρυσ σμυρνης",
    "πτολεμαιδα θεολογιδη", "φλωρινα cash & carry",
...
GROUPS_MAPPING = {
    "τομεας 3": TOMEAS_3_KEYWORDS,
    "τομέας 3": TOMEAS_3_KEYWORDS,
    "μητρουλης": MITROULIS_KEYWORDS,
    "πονοπουλος": PONOPOULOS_KEYWORDS,
    "χαραλαμπιδης": CHARALAMPIDIS_KEYWORDS,
    "παππας": PAPPAS_KEYWORDS,
    "πατσης": PATSIS_KEYWORDS,
    "σκιαδοπουλος": SKIADOPOULOS_KEYWORDS,
    "σαμογλου": SAMOGLOU_KEYWORDS,
    "μπουτσκος": BOUTSKOS_KEYWORDS,
    ...
    if active_filter:
        if active_filter in GROUPS_MAPPING:
            ...
            filtered_df = filtered_df[
                filtered_df["Κατάστημα"]
                .str.lower()
                .str.contains(active_filter, na=False)
            ]
...
df_stores_1, total_sum_1 = filter_dataframe(df_stores_1)
df_stores_2, total_sum_2 = filter_dataframe(df_stores_2)
...
try:
    ...
    html_content += """
            <div class="watermark">Dashboard Sales App</div>
        </div>
    </div>
    """
